...
@Configuration
@EnableJpaRepositories(basePackages = "com.webstotales.eSchool")
@EnableTransactionManagement
public class JpaConfig implements DisposableBean{
	 private static final String PROPERTY_NAME_DATABASE_DRIVER = "com.mysql.jdbc.Driver";
	    private static final String PROPERTY_NAME_DATABASE_URL = "jdbc:mysql://localhost:3306/eSchool";
	    ...
	    public LocalContainerEntityManagerFactoryBean entityManagerFactory(){
	        ...
	        lcemfb.setPackagesToScan(new String[] {"com.webstotales.eSchool"});
